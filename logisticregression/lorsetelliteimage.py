...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 15 19:20:03 2022
...
image_set = pd.read_csv("/home/dai/Desktop/dai2022/modulewise/practicalmachinelearning/Cases/Satellite Imaging/Satellite.csv",sep=';')                         
x = image_set.drop('classes',axis=1)
y = image_set['classes']
...
gcv = GridSearchCV(logreg, param_grid=params,scoring='roc_auc_ovr',cv=kfold)
gcv.fit(x,le_y)
